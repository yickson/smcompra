...
class AppController extends Controller
{
    ...
    final protected function initialize()
    {
      ...
      if(Administrador::logged()) $this->userRol =$rol;
        ...
        $this->acl->add_resource(new AclResource('usuarios'), 'index', 'editar', 'listar_con_hijos', 'consultarHijos', 'consultarDireccion');
        ...
        $this->acl->add_resource(new AclResource('webpay'), 'index', 'licencias', 'productos', 'ingresos', 'listar_operaciones', 'compras_licencias', 'compra_productos', 'licPorcentaje', 'texPorcentaje');

        //Se crean los permisos
         // Inicio
        //$this->acl->allow("1", '*', '*'); No lee el comodín
        $this->acl->allow('1', 'usuarios', array('index', 'editar', 'listar_con_hijos', 'consultarHijos', 'consultarDireccion'));
        ...
        $this->acl->allow('1', 'webpay', array('index', 'licencias', 'productos', 'ingresos', 'listar_operaciones', 'compras_licencias', 'compra_productos', 'licPorcentaje', 'texPorcentaje'));
         // Acceso para el usuario nivel 2 CallCenter
        $this->acl->allow('2', "usuarios", array('index', 'editar', 'listar_con_hijos', 'consultarHijos', 'consultarDireccion'));
        ...
        // Acceso para el usuario nivel 3 Parvularios
         ...
         $this->acl->allow('3', 'webpay', array('index', 'licencias', 'productos', 'ingresos', 'listar_operaciones', 'compras_licencias', 'compra_productos', 'licPorcentaje', 'texPorcentaje'));
